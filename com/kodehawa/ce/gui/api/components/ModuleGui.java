...
public class ModuleGui extends GuiScreen
{
    ...
    {
        Frame wFrame = new Frame(CheatingEssentials.instance(), 10, 10, 120, 20, 0x96777777, 0xaa000000, "World");
    ...
    {
        Frame rFrame = new Frame(CheatingEssentials.instance(), 130, 50, 120, 20, 0x96777777, 0xaa000000, "Render");
    ...
    public void makeF3UtilsFrame(){
    	Frame f3Frame = new Frame(CheatingEssentials.instance(), 10, 50, 120, 20, 0x96777777, 0xaa000000, "Utils");
    ...
    {
        Frame pFrame = new Frame(CheatingEssentials.instance(), 130, 10, 120, 20, 0x96777777, 0xaa000000, "Player");
    ...
    {
        Frame kFrame = new Frame(CheatingEssentials.instance(), 10, 30, 120, 20, 0x96777777, 0xaa000000, "Keybinds")
        {
            @Override
            public void update()
            {
    ...
    public void makeRadarFrame()
    {
        ...
        Frame rFrame = new Frame(CheatingEssentials.instance(), 250, 30, 120, 20, 0x96777777, 0xaa000000, "Radar")
        {
            @Override
            public void update()
            {
    ...
    {
        Frame aFrame = new Frame(CheatingEssentials.instance(), 130, 30, 120, 20, 0x96777777, 0xaa000000, "Active Cheats")
        {
            @Override
            public void update()
            {
    ...
    {
        final Frame iFrame = new Frame(CheatingEssentials.instance(), 250, 10, 120, 20, 0x96777777, 0xaa000000, "Player Info")
        {
            @Override
            public void update()
            {
